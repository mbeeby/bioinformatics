...
def main():
    ...
    #organisms = wa.organisms.get_organisms(common_name=organism)
    #for o in organisms:
    #    print organisms

    features = wa.organisms.get_sequences(organism)#   , export_format='text',seq_type='peptide',export_type="FASTA")
